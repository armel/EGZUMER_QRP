...
Cloner le repository ou télécharger le ou les firmwares qui vous intéressent (_download raw file_). Utiliser le [flasheur](https://egzumer.github.io/uvtools/) en ligne.
